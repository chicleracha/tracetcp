...
#if !defined(___TRACETCP__StandardTraceOutput__INCLUDED___)
#define ___TRACETCP__StandardTraceOutput__INCLUDED___

#include "ITraceOutput.h"

class StandardTraceOutput : public ITraceOutput
{
    private:
        int  m_goodPings;
        bool m_noRDNS;
